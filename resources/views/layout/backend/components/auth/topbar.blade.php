<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light"
                        src="{{ asset('assets/backend/images/logo/logo.jpg') }}" alt="" style="height: 50px; !important"><img class="img-fluid for-dark"
                        src="{{ asset('assets/backend/images/logo/logo_dark.jpg') }}" alt="" style="height: 50px; !important"></a></div>
            <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle"
                    data-feather="align-center"></i></div>
        </div>
        {{-- <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div class="notification-slider">
                <div class="d-flex h-100"> <img src="{{ asset('assets/backend/images/giftools.gif') }}" alt="gif">
                    <h6 class="mb-0 f-w-400"><span class="font-primary">Don't Miss Out! </span><span
                            class="f-light">Out new update has been release.</span></h6>
                </div>
                <div class="d-flex h-100"><img src="{{ asset('assets/backend/images/giftools.gif') }}" alt="gif">
    ...
    <div class="ProfileCard-realName">Rajamurugan</div>
    </div>
    </div>
  </script>

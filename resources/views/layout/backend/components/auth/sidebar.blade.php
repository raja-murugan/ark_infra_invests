<div class="sidebar-wrapper" data-sidebar-layout="stroke-svg">
    <div>
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light"
                    src="{{ asset('assets/backend/images/logo/logo.jpg') }}" alt="" style="height: 50px;"><img
                    class="img-fluid for-dark" src="{{ asset('assets/backend/images/logo/logo_dark.jpg') }}"
                    alt="" style="height: 50px;"></a>
            <div class="back-btn"><i class="fa fa-angle-left"></i></div>
            <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
        </div>
        <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid"
                    src="{{ asset('assets/backend/images/logo/logo-icon.jpg') }}" alt="" style="height: 50px;"></a></div>
        <nav class="sidebar-main">
            <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    <li class="back-btn"><a href="index.html"><img class="img-fluid"
                                src="{{ asset('assets/backend/images/logo/logo-icon.jpg') }}" alt="" style="height: 50px;"></a>
